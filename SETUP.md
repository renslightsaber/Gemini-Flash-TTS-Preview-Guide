...
```bash
cd /home/aithe209/Gemini_Flash_TTS_Preview_Guide   # 프로젝트 폴더로 이동
cp .env.example .env
```
...
**venv (표준 라이브러리)**
```bash
cd /home/aithe209/Gemini_Flash_TTS_Preview_Guide
python3 -m venv .venv
...
git remote add origin git@github.com:renslightsaber/Gemini-Flash-TTS-Preview-Guide.git
